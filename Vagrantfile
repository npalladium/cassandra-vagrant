...
sudo apt-get -qq install -y -o=Dpkg::Use-Pty=0 python3 python3-pip python3-dev python3-venv python3-setuptools curl wget gnupg
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define "cass" do |cass|
    ...
    cass.vm.network "forwarded_port", guest: 9042, guest_ip: "127.0.0.1", host: 9042, protocol: "tcp"
    cass.vm.network "forwarded_port", guest: 9042, guest_ip: "127.0.0.1", host: 9042, protocol: "udp"
